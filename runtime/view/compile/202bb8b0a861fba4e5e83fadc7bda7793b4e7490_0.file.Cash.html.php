<?php
/* Smarty version 3.1.46, created on 2026-03-05 15:01:25
  from '/var/www/html/app/View/Admin/User/Cash.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_69a92a45574856_36375828',
...
function content_69a92a45574856_36375828 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header">
                    <div class="card-toolbar">
                        <button class="btn btn-sm btn-light-primary settlement me-3"><i class="fa-duotone fa-regular fa-money-bill-transfer"></i>
                            一键自动结算
                        </button>
                    </div>
                </div>
                ...
                columns: [
                   {
                    ...
                    },
                    {
                        ...
                        formatter: function (val, item) {
                            ...
                            let html = '<button type="button"  class="btn btn-icon btn-light-success btn-sm me-1 success"><i class="fa-duotone fa-regular fa-circle-check"></i></button> ';
                            html += '<button type="button"  class="btn btn-icon btn-light-danger btn-sm me-1 error"><i class="fa-duotone fa-regular fa-circle-exclamation"></i></button> ';
                            return html;
                        },
                        events: {
...
<?php echo '</script'; ?>
>
<?php echo ready("/assets/admin/controller/user/cash.js");?>
