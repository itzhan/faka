<?php
/* Smarty version 3.1.46, created on 2026-03-05 15:00:26
  from '/var/www/html/app/View/Install.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_69a92a0ae50d45_44470857',
...
function content_69a92a0ae50d45_44470857 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <fieldset class="section">
                ...
                <input type="text" name="host" placeholder="数据库地址" value="<?php echo $_smarty_tpl->tpl_vars['db_host']->value;?>
">
                <input type="text" name="database" placeholder="数据库名称" value="<?php echo $_smarty_tpl->tpl_vars['db_database']->value;?>
">
                <input type="text" name="username" placeholder="数据库账号" value="<?php echo $_smarty_tpl->tpl_vars['db_username']->value;?>
">
                <input type="text" name="password" placeholder="数据库密码" value="<?php echo $_smarty_tpl->tpl_vars['db_password']->value;?>
">
                <input type="text" name="prefix" placeholder="数据库前缀" value="<?php echo $_smarty_tpl->tpl_vars['db_prefix']->value;?>
">
